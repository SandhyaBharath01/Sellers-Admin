...
function addItems(e){
    ...
    const endPointUrl = "https://crudcrud.com/api/cb8adfd1a1524b67bdede952328cd30d/expense"
  ...
  window.addEventListener("DOMContentLoaded",()=>{
    ...
    axios.get("https://crudcrud.com/api/cb8adfd1a1524b67bdede952328cd30d/expense").then((res)=>{
  ...
  function showUserOnScreen(productDetails){
    ...
    delButton.addEventListener("click",()=>{
      axios.delete(`https://crudcrud.com/api/cb8adfd1a1524b67bdede952328cd30d/expense/${productDetails._id}`).then(()=>{
        li.remove()
      }).catch(err => console.log(err))
    })
  }  
